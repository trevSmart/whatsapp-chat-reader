#!/usr/bin/env python3
"""
WhatsApp Chat Reader - Smart Virtual Scrolling Version
Genera un fitxer HTML únic amb càrrega progressiva i lazy loading intel·ligent.
"""
...
from whatsapp_chat_reader.smart_virtual_generator import SmartVirtualHTMLGenerator

def main():
    parser = argparse.ArgumentParser(
        description="WhatsApp Chat Reader - Smart Virtual Scrolling Version",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemples d'ús:
  python smart_virtual_chat.py chat.txt
  python smart_virtual_chat.py chat.txt --attachments ./adjunts --chat-name "El meu xat"
  python smart_virtual_chat.py chat.txt --output ./output.html --chunk-size 200
        """
    )
    ...
    parser.add_argument(
        "--output",
        help="Fitxer de sortida HTML (per defecte: chat_smart.html)"
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=200,
        help="Mida dels chunks de missatges (per defecte: 200)"
    )
    ...
    if not args.output:
        ...
        args.output = chat_file_path.parent / "chat_smart.html"

    # Set default chat name
    if not args.chat_name:
        args.chat_name = "WhatsApp Chat"

    print("🚀 Iniciant WhatsApp Chat Reader - Versió Intel·ligent")
    ...
    try:
        ...
        # Generate HTML
        print("🎨 Generant HTML intel·ligent...")
        generator = SmartVirtualHTMLGenerator()
        ...
        print("   • Lazy loading intel·ligent per adjunts")
        print("   • Cerca en temps real")
        print("   • Adjunts carregats sota demanda")
        ...
        print("   • Fitxer HTML lleuger i ràpid")
