...
class HybridVirtualHTMLGenerator:
    def __init__(self):
        self.css_styles = """
        <style>
            body {
    ...
    def generate_html(self, messages: List[WhatsAppMessage], attachment_map: Dict[str, str], chat_name: str = "WhatsApp Chat") -> str:
        """Generate HTML with hybrid virtual scrolling."""

        print("Processant missatges per chunks híbrids...")
...
<body>
    ...
    <script>
        // Chunks data embedded as JavaScript variables
        {chunks_js_str}

        class HybridVirtualChat {{
            constructor() {{
            ...
            loadChunksOnScroll() {{
                ...
                const loadRange = 2; // Load 2 chunks before and after current position
        ...
        // Initialize hybrid virtual chat when page loads
        document.addEventListener('DOMContentLoaded', () => {{
            new HybridVirtualChat();
        }});
    </script>
</body>
</html>'''
